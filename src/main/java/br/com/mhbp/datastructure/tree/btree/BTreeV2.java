package br.com.mhbp.datastructure.tree.btree;
...
//https://github.com/phishman3579/java-algorithms-implementation/tree/master/src/com/jwetherell/algorithms/data_structures

public class BTreeV2<T extends Comparable<T>> implements ITree<T> {
    ...
    private static class Node<T extends Comparable<T>> {
        ...
        private Comparator<Node<T>> comparator = new Comparator<BTreeV2.Node<T>>() {
            @Override
            public int compare(BTreeV2.Node<T> arg0, BTreeV2.Node<T> arg1) {
    ...
    private static class TreePrinter {
        ...
        public static <T extends Comparable<T>> String getString(BTreeV2<T> tree) {
    ...
    public static class JavaCompatibleBTree<T extends Comparable<T>> extends java.util.AbstractCollection<T> {
        ...
        private BTreeV2<T> tree = null;

        public JavaCompatibleBTree(BTreeV2<T> tree) {
            this.tree = tree;
        }
        ...
        private static class BTreeIterator<C extends Comparable<C>> implements java.util.Iterator<C> {
            ...
            private BTreeV2<C> tree = null;
            private BTreeV2.Node<C> lastNode = null;
            private C lastValue = null;
            private int index = 0;
            private Deque<Node<C>> toVisit = new ArrayDeque<Node<C>>();

            protected BTreeIterator(BTreeV2<C> tree) {
                this.tree = tree;
